...
/* X-NUCLEO-NFC05 GPIO/LEDs configuration
    IRQ_MCU      A0 = CN8.1
    MCU_LED1 PA1 A1 = CN8.2
    MCU_LED2 PA4 A2 = CN8.3
    MCU_LED3 PB0 A3 = CN8.4
    MCU_LED4 PB4 D5 = CN9.6
    MCU_LED5 PB5 D4 = CN9.5
    ...
    According to the MCU/Pi connector mapping:
    CE1 = 7  (IRQ_MCU)
    P21 = 5  (MCU_LED1 = LED F)
    P22 = 6  (MCU_LED2 = LED B)
    P23 = 13 (MCU_LED3 = LED A)
    P3  = 22 (MCU_LED4 = LED V)
    P2  = 27 (MCU_LED5 = LED AP2P)
    P5  = 24 (MCU_LED6 = TX)
...
#define PLATFORM_LED_V_PIN               22
#define PLATFORM_LED_AP2P_PIN            27
...
#define platformDelay(t)                              usleep(t*1000)                                           /*!< Performs a delay for the given time (ms)    */
